...
\begin{itemize}
    ...
    \item extra: Expand Product backlog to better fit the requirements
\end{itemize}
...
This section contains all the functional and non-functional requirements of the system. Requirements associated to a user story ID marked with an asterisk (*) means that this requirement does not yet have a properly defined user story. This is because the requirements were defined after the first sprint started.
